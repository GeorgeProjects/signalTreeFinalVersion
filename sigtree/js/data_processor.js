...
sigtree.dataProcessor = function() {
    ...
    function treefy(dts){
        ...
        for(var i = 0;i < root.children;i++){
            sumFlow = sumFlow + root.children[i].flow;
            console.log(root.children[i].flow);
            sumChildCount = sumChildCount + root.children[i].allChilldrenCount;
            console.log('sumChildCount', sumChildCount);
        }
        root.flow = sumFlow;
        root.allChilldrenCount = sumChildCount;*/
        return root;
    }
